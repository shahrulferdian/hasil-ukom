                                        ...
                                        <li class="comment byuser comment-author-admin bypostauthor even thread-even depth-1" id="li-comment-20">
                                            @foreach ($product->orderItems->where('rstatus',1) as $orderItem)
                                                <div id="comment-20" class="comment_container">
                                                    <img alt="" src="{{ asset('assets/images/profile') }}/{{$orderItem->order->user->profile->image}}"" height="80" width="80">
                            ...
                            @foreach ($related_products as $related)
                                <div class="product product-style-2 equal-elem ">
                                    <div class="product-thumnail">
                                        <a href="{{ route('product.details', ['slug'=>$related->slug]) }}" title="{{ $related->name}}" title="{{$related->name}}">
                                        ...
                                        <div class="wrap-btn">
                                            <a href="{{ route('product.details', ['slug'=>$related->slug]) }}" class="function-link">quick view</a>
                                        </div>
                                    </div>
                                    <div class="product-info">
